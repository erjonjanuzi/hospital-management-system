    ...
    return (
        <>
            ...
            <Formik
                ...
                onSubmit={(values) => console.log(values)/*registerDoctor(values).catch(error => console.log(error)).then(modalStore.closeModal)*/}
                enableReinitialize
            >
                    ...
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        <Grid>
                            ...
                            <Grid.Column width='8'>
                                ...
                                <Label content='Date of birth' icon='calendar' color='blue' basic/>
